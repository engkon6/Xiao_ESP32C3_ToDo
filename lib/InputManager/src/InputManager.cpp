...
// No ADC buttons - using only power button (GPIO6)
const int InputManager::ADC_RANGES_1[] = {ADC_NO_BUTTON, INT32_MIN};
const int InputManager::ADC_RANGES_2[] = {ADC_NO_BUTTON, INT32_MIN};
