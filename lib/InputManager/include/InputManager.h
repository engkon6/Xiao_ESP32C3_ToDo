...
class InputManager {
 ...
 /**
  ...
  // Pins (Remapped for XIAO ESP32C3 - Power on GPIO6, no ADC buttons)
  // Note: GPIO6 is used for power button (D4 on XIAO)
  static constexpr int BUTTON_ADC_PIN_1 = 0; // Not used
  static constexpr int BUTTON_ADC_PIN_2 = 0; // Not used
  static constexpr int POWER_BUTTON_PIN = 6; // D4 (GPIO6) - Power button
 ...
 private:
  ...
  static constexpr int NUM_BUTTONS_1 = 0;
  static const int ADC_RANGES_1[];

  static constexpr int NUM_BUTTONS_2 = 0;
